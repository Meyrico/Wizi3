...
if($data == 'reciveApplications') {
    ...
    از این قسمت میتونید برنامه مورد نیاز رو نسبت به دستگاه خودتون دانلود و نصب کنید و از آموزش های کاملی که قرار داده شده
    برای یادگیری نحوه اتصال به سرویس های V2worldVPN استفاده کنید 🌹
