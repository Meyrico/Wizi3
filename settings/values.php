...
🔮 نام سرویس: REMARK
💮 سفارش: FILENAME",
    'renew_order_sent'=>"✅| دوست عزیز ، درخواستت با موفقیت ثبت شد، بعد از بررسی ادمین کانفیگ رو برات تمدید میکنم ممنون از صبوریت 
...
",
    ...
    'send_only_number'=> "لطفا فقط عدد بفرستید، مچکرم",
    ...
    'start_message'=>'سلااام به ربات V2world خوش اومدی 🫡🌸
    
    تماس با پشتیبانی : @v2wsup
...
💰مقدار تخفیف: AMOUNT تومان
⁮⁮ ⁮⁮",
"send_config_uuid"=>"❗️| لینک کانفیگ رو برام بفرست تا اطلاعات کاملش رو بهت نشون بدم",
...
$buttonValues = [
    ...
    'application_links'=>'💡راهنمای اتصال و دانلود اپلیکیشن ها',
